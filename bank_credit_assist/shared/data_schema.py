...
# 文件名关键词 → 候选 doc_code 列表（长关键词优先匹配）
...
# 扩展名 → 倾向的 doc_code 列表（作为加分项）
CLASSIFICATION_EXTENSION_HINTS: dict[str, list[str]] = {
    ".xlsx": ["B1", "B2", "B3", "B4"],
    ".xls":  ["B1", "B2", "B3", "B4"],
    ".xlsm": ["B1", "B2", "B3", "B4"],
    ".jpg":  ["A1", "A2", "A5", "C1", "D1", "D4"],
    ".jpeg": ["A1", "A2", "A5", "C1", "D1", "D4"],
    ".png":  ["A1", "A2", "A5", "C1", "D1", "D4"],
}

CLASSIFICATION_CONFIDENCE_HIGH = "high"
CLASSIFICATION_CONFIDENCE_MEDIUM = "medium"
CLASSIFICATION_CONFIDENCE_LOW = "low"
